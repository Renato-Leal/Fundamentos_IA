...
class TicTacToeBoard(Board):
    ...
    #Función para contar las fichas de cada jugador y determinar el ganador
    def contar_fichas(self): 
        """Cuenta cuántas fichas hay en el tablero de cada color"""
        negras = sum(fila.count(self.__player1) for fila in self)
        blancas = sum(fila.count(self.__player2) for fila in self)
